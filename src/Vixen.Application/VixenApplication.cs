...
namespace VixenApplication
{
    public partial class VixenApplication : BaseForm, IApplication
    {
        ...
        private void UpdateVersionInfo()
        {
            if (_devBuild)
            {
                var versionColor = _testBuild ? Color.Tomato : Color.Yellow;
                vixenReleaseLabel.ForeColor = versionColor;
                vixenVersionLabel.ForeColor = versionColor;
            }
            vixenReleaseLabel.Text = _releaseVersion;
            vixenVersionLabel.Text = _buildVersion;
        }
